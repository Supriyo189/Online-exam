            ...
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                        <button type="button" class="btn btn-primary btn-sm ediBtn" data-id="{{$item->id}}" data-title="{{$item->course_title}}" data-ccode="{{$item->course_code}}" data-tcode="{{$item->teacher_code}}" data-noq="{{$item->number_of_question}}" data-time="{{$item->time}}" data-dept="{{$item->department_id}}" data-etype="{{$item->examtype_id}}"><i class="far fa-eye mr-2"></i>View</button>
                    </td>
                  </tr>
                  @endforeach         
              </tbody>
