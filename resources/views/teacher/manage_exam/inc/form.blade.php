          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="POST" class="form-horizontal" action="{{action('Teacher\ManageExamController@update')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="offset-sm-4 col-sm-10">
                              <button type="submit" class="btn btn-success">Update Exam Info</button>
                            </div>
                        </div>
                      </form>
                  <!-- /.tab-content -->
